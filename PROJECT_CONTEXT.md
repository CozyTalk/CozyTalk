...
### Tests
569 Flutter unit + widget tests across auth, chat, matchmaking, profile, hello, friends, and notification screens. See [Test Coverage](#quality-gates-definition-of-done) for the full breakdown.
...
|---|---|---|---|
| Flutter unit + widget | 569 tests | `apps/mobile/test/` | Nothing |
